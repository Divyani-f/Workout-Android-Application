 ...
 * Use the {@link NewWorkout#newInstance} factory method to
...
public class NewWorkout extends Fragment {
    ...
    public static NewWorkout newInstance(String param1, String param2) {
        NewWorkout fragment = new NewWorkout();
